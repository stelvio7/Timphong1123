...
public class TransActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        header = this.getLayoutInflater().inflate(R.layout.list_item_header, null, false);
    ...
    private void networkGetHomeListData(){
        RestAdapter restAdapter = new RestAdapter.Builder()
                ...
                .build();
        Util.showProgress(TransActivity.this);

        /*restAdapter.create(Info.class).regiUser(Util.getDeviceId(mContext), "I", "C", "", "", new Callback<RegistUserInfo>() {
            @Override
