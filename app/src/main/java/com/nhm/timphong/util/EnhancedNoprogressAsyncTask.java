 ...
 *
 */
public abstract class EnhancedNoprogressAsyncTask<Params, Progress, Result, WeakTarget extends Context>
    ...
    /** �۾�ó���� ���̾�α׸� �������� ���� */
    protected boolean mProgressDialogEnabled = false;

    public EnhancedNoprogressAsyncTask(WeakTarget target) {
    ...
    protected void showProgress(Context context) {
        ...
        mProgressDialog.setOnCancelListener(new OnCancelListener() {
            public void onCancel(DialogInterface dialog) {
                ...
                EnhancedNoprogressAsyncTask.this.cancel(true);
            }
        });
